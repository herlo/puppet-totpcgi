...
class totpcgi (
  ...
  class { 'totpcgi::config':
    ...
    secret_mysql_connect_password  => $::secret_connect_password,
    ...
    pincode_mysql_connect_password => $::pincode_connect_password,
    ...
    state_mysql_connect_password   => $::state_connect_password,
